...
const sites: Site[] = [
  ...
  { name: "Mac-O-Roni", industry: "Mac & Cheese Truck", url: "https://mack-o-roni.vercel.app", style: "V5", colors: ["#FCD34D", "#F97316"], font: "Fredoka", description: "Fun yellow/orange, toppings bar", pages: "single", features: ["framer-motion", "playful-hover", "menu-cards", "light-theme"] },
